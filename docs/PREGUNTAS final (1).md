...
| **Qué es PILAR?** | **PILAR** era un Sistema de de la UNA Puno. Era la plataforma donde se gestionaban los proyectos de tesis, ahora se llama Plataforma de Gestion de la Investigación.|
...
| **Cuáles son las líneas de investigación de estadística?** | El reglamento no detalla líneas específicas por carrera. Consulta con la **unidad de investigación** de tu facultad o en la **PGI** las sub-líneas disponibles en tu Escuela Profesional. |
